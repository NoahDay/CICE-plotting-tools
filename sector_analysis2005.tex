...
\graphicspath{ {./sector_analysis2005_images/} }
...
grid = 'gx1';
case_name = '3month';
filedir = 'cases/twoyearproper/history/iceh.2005-09-30.nc';
...
\begin{matlabcode}
%
monthfile = 'cases/test/history/iceh.2006-09.nc';%'grid/gridded_ww3.glob_24m.200501.nc'; 
...
[lat,lon,row] = grid_read(grid);
variable = "sigP_m";
data = data_format(monthfile,'sigP_m',row,lat,lon,2);
fig_count = fig_count + 1;
figure(fig_count)
w= map_plot(data,variable,sector);   
