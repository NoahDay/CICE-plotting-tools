...
% Comparing CICE results with and without waves
 ...
 variable = 'wave_sig_ht_d'; % wave_sig_ht, peak_period, fsdrad, 
...
filedir1 = strcat(case1dir,'/history/iceh.',date,'.nc');
filedir2 = strcat(case2dir,'/history/iceh.',date,'.nc');

f1 = figure;
comparison_maker(filedir1, plot_title1, plot_title2, variable, grid, map_type, user);
